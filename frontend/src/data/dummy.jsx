...
import { FaBox, FaCalendar, FaIdBadge, FaRobot, FaSignInAlt, FaWaveSquare } from "react-icons/fa";
...
export const EditorData = () => (
  <div>
    <h3>
      Nitesh Singh
      <br></br>I am a skilled developer with expertise in React.js, Node.js,
      MongoDB, and Firebase, demonstrated through projects like *Le-Chalo* (real
      estate booking platform), *NitTube* (YouTube replica using React.js and
      YouTube API), and *Admin Dashboard* (fully responsive with advanced
      charting and theme customization).
      <br></br>
      My technical skill set includes programming languages like C, C++, and
      JavaScript, and web technologies like MySQL, Bootstrap, and RESTful APIs.
      I am proficient with tools such as Visual Studio Code, Git, and Figma,
      complemented by a strong foundation in data structures, algorithms, and
      UI/UX design.
      <br></br>I have actively participated in leadership roles, serving as the
      **Design Head of various clubs like *TechnicalBoard*, *Spiritual Club*,
      *Sports Club*, and *PR Club*. I successfully organized the *Alumni Meet
      2022-23 and 2024-25*,various events of the collage and led project-based
      learning initiatives.
      <br></br>
      My achievements include: - Won the Tech-Elevate competition organized by
      the Technical Board. - Awarded Best Decode Branding organized by E-Cell. -
      Selected for Smart AIT for exceptional technical performance. - Won the
      Inter College Volleyball Tournament showcasing teamwork and sportsmanship.
      - Achieved Best PBL Project in the first year of engineering. - Design
      head of various clubs of the collage - TechnicalBoard, Spiritual Club,
      Sports Club, and PR Club
    </h3>
  </div>
);
...
export const recentTransactions = [
  // Income Transactions
  {
    ...
    amount: "+₹7,500",
    title: "Salary Credit",
    desc: "Salary received from employer",
    iconColor: "#03C9D7",
    iconBg: "#E5FAFB",
    pcColor: "green-600",
  },
  {
    ...
    desc: "Website development project",
    iconColor: "#32CD32",
    iconBg: "#D3D3D3",
    pcColor: "green-600",
  },
  {
    ...
    desc: "Quarterly dividend credited",
    iconColor: "#FFD700",
    iconBg: "#FFF8DC",
    pcColor: "green-600",
  },
  {
    ...
    desc: "Credit card cashback credited",
    iconColor: "#FF1493",
    iconBg: "#FFE4E1",
    pcColor: "green-600",
  },
  ...
  },
  {
    ...
    desc: "Paid full outstanding balance",
    iconColor: "#FF6347",
    iconBg: "#FFDAB9",
    pcColor: "red-600",
  },
  ...
  },
  {
    ...
    desc: "Tata Power electricity bill paid",
    iconColor: "#008080",
    iconBg: "#E0FFFF",
    pcColor: "red-600",
  },
  ...
  },
  {
    ...
    amount: "-₹8,000",
    title: "Loan EMI",
    desc: "Personal loan installment",
    iconColor: "#8B0000",
    iconBg: "#FAEBD7",
    pcColor: "red-600",
  },
...
export const productsPerformance = [
  ...
  },
  {
    ...
    desc: "Baking, Sweet, Delicious",
    rating: "Excellent",
    itemSold: "95%",
    earningAmount: "$1,200,000",
  },
  {
    image: product2,
    title: "Premium espresso coffee",
    desc: "Coffee, Beverage, Hot",
    rating: "Good",
    itemSold: "82%",
    earningAmount: "$890,000",
  },
  {
    image: product3,
    title: "Fresh organic spinach leaves",
    desc: "Vegetables, Fresh, Green",
    rating: "Excellent",
    itemSold: "98%",
    earningAmount: "$450,000",
  },
  {
    image: product4,
    title: "Luxury scented candles",
    desc: "Home Decor, Fragrance, Relaxation",
    rating: "Good",
    itemSold: "78%",
    earningAmount: "$560,000",
  },
  {
    image: product5,
    title: "Crunchy peanut butter spread",
    desc: "Snacks, Butter, Healthy",
    rating: "Average",
    itemSold: "65%",
    earningAmount: "$340,000",
  },
  {
    image: product6,
    title: "Ultra-soft bath towels",
    desc: "Home, Comfort, Absorbent",
    rating: "Excellent",
    itemSold: "88%",
    earningAmount: "$730,000",
  },
  {
    image: product7,
    title: "Wireless noise-cancelling headphones",
    desc: "Electronics, Audio, Portable",
    rating: "Good",
    itemSold: "80%",
    earningAmount: "$1,500,000",
  },
  {
    image: product8,
    title: "Handcrafted ceramic mugs",
    desc: "Kitchenware, Artistic, Durable",
    rating: "Good",
    itemSold: "72%",
    earningAmount: "$480,000",
  },
  {
    // image: product9,
    title: "Deluxe king-size mattress",
    desc: "Furniture, Comfort, Sleep",
    rating: "Excellent",
    itemSold: "93%",
    earningAmount: "$2,300,000",
  },
  {
    // image: product10,
    title: "Limited edition wristwatch",
    desc: "Fashion, Timepiece, Luxury",
    rating: "Average",
    itemSold: "55%",
    earningAmount: "$970,000",
  },
  {
    // image: product11,
    title: "Freshly baked sourdough bread",
    desc: "Bakery, Bread, Artisanal",
    rating: "Good",
    itemSold: "75%",
    earningAmount: "$300,000",
  },
  {
    // image: product12,
    title: "Natural honey with herbs",
    desc: "Food, Sweetener, Organic",
    rating: "Excellent",
    itemSold: "92%",
    earningAmount: "$400,000",
  },
  {
    // image: product13,
    title: "High-speed blender for smoothies",
    desc: "Kitchen, Appliances, Healthy",
    rating: "Good",
    itemSold: "85%",
    earningAmount: "$920,000",
  },
  {
    // image: product14,
    title: "Cozy woolen sweaters",
    desc: "Clothing, Winter, Warm",
    rating: "Good",
    itemSold: "78%",
    earningAmount: "$530,000",
  },
  {
    // image: product15,
    title: "Eco-friendly bamboo toothbrush",
    desc: "Health, Hygiene, Sustainable",
    rating: "Excellent",
    itemSold: "96%",
    earningAmount: "$150,000",
  },
  {
    // image: product16,
    title: "Premium green tea bags",
    desc: "Beverage, Healthy, Relaxing",
    rating: "Excellent",
    itemSold: "91%",
    earningAmount: "$210,000",
  },
  {
    // image: product17,
    title: "Portable camping tent for 2",
    desc: "Outdoors, Adventure, Durable",
    rating: "Good",
    itemSold: "81%",
    earningAmount: "$470,000",
  },
  {
    // image: product18,
    title: "Organic hair care shampoo",
    desc: "Beauty, Natural, Nourishing",
    rating: "Average",
    itemSold: "63%",
    earningAmount: "$340,000",
  },
  {
    ...
    desc: "Fitness, Hydration, Reusable",
    rating: "Excellent",
    itemSold: "90%",
    earningAmount: "$180,000",
  },
  {
    // image: product20,
    title: "Lightweight travel backpack",
    desc: "Travel, Compact, Functional",
    rating: "Good",
    itemSold: "84%",
    earningAmount: "$690,000",
  },
  {
    image: product6,
...
export const finTrackerSummary = {
  data: [
    {
      title: "Next Bill Due",
      desc: "April 10, 2025",
...
export const rolesData = [
  ...
  { RoleID: 2, RoleName: "Editor", Permissions: "Read, Write, Edit" },
  {
    RoleID: 3,
    RoleName: "Manager",
    Permissions: "Read, Write, Edit, Assign Roles",
  },
  { RoleID: 4, RoleName: "Support", Permissions: "Read, Respond to Tickets" },
  {
    RoleID: 5,
    RoleName: "Contributor",
    Permissions: "Write, Edit Own Content",
  },
  {
    RoleID: 6,
    RoleName: "Moderator",
    Permissions: "Read, Delete Content, Ban Users",
  },
  { RoleID: 7, RoleName: "Viewer", Permissions: "Read Only" },
  {
    RoleID: 8,
    RoleName: "Editor-in-Chief",
    Permissions: "Read, Write, Edit, Manage Content",
  },
  {
    RoleID: 9,
    RoleName: "Admin Assistant",
    Permissions: "Read, Add Users, Assign Roles",
  },
  {
    RoleID: 10,
    RoleName: "Customer Service",
    Permissions: "Read, Respond to Support Requests",
  },
  { RoleID: 11, RoleName: "Guest", Permissions: "Read Only (Limited Access)" },
  {
    RoleID: 12,
    RoleName: "HR Manager",
    Permissions: "Read, Write, Manage Employees",
  },
  {
    RoleID: 13,
    RoleName: "Team Lead",
    Permissions: "Read, Assign Tasks, Edit Projects",
  },
  {
    RoleID: 14,
  ...
  },
  {
    ...
    Permissions: "Read, Write, Edit, Manage Products",
  },
  {
    RoleID: 16,
    RoleName: "Financial Analyst",
    Permissions: "Read, Write, Access Reports",
  },
];
...
export const lineChartData = [
  // First dataset
  [
    { x: new Date(2025, 2, 1), y: 21 },
    { x: new Date(2025, 2, 5), y: 24 },
    { x: new Date(2025, 2, 10), y: 36 },
    { x: new Date(2025, 2, 15), y: 38 },
    { x: new Date(2025, 2, 20), y: 54 },
    { x: new Date(2025, 2, 25), y: 57 },
    { x: new Date(2025, 2, 30), y: 70 },
  ],
  // Second dataset
  [
    { x: new Date(2025, 2, 1), y: 28 },
    { x: new Date(2025, 2, 5), y: 44 },
    { x: new Date(2025, 2, 10), y: 48 },
    { x: new Date(2025, 2, 15), y: 50 },
    { x: new Date(2025, 2, 20), y: 66 },
    { x: new Date(2025, 2, 25), y: 78 },
    { x: new Date(2025, 2, 30), y: 84 },
  ],
  // Third dataset
  [
    { x: new Date(2025, 2, 1), y: 10 },
    { x: new Date(2025, 2, 5), y: 20 },
    { x: new Date(2025, 2, 10), y: 30 },
    { x: new Date(2025, 2, 15), y: 39 },
    { x: new Date(2025, 2, 20), y: 50 },
    { x: new Date(2025, 2, 25), y: 70 },
    { x: new Date(2025, 2, 30), y: 100 },
  ],
];
...
export const giftCards = [
  {
    ...
    value: "$50",
    // image: "src/data/amazon.png",
  },
  {
    id: 2,
    name: "Netflix Gift Card",
    value: "$25",
    // image: "https://example.com/netflix-card.jpg",
  },
  {
    id: 3,
    name: "Google Play Gift Card",
    value: "$30",
    // image: "https://example.com/google-play-card.jpg",
  },
];
...
export const transactionsGrid = [
  ...
  { field: "type", headerText: "Type", width: "120", textAlign: "Center" },
  {
    field: "category",
    headerText: "Category",
    width: "150",
